...
export default function WorkList() {
  const works = [
    ...
    },
    {
      ...
      techstacks: 'https://api.github.com/repos/hudy9x/kompad/languages',
      desc: `A beautiful app that allows you to create, edit, synchronize your technical documents. Even customize your own look.`
    },
    {
      thumb: '/keyreader.png',
          ...
          {works.map((work, index) => (
              <li key={index} className="mb-8">
                <div className="flex items-center gap-4">
                  <img className="w-20 h-20 object-cover rounded-md" src={work.thumb} alt={`${work.name} thumbnail`} />
                  <div>
                    <h4 className="text-lg font-semibold">{work.name}</h4>
                    ...
                    <p className="mt-2 text-sm">{work.desc}</p>
